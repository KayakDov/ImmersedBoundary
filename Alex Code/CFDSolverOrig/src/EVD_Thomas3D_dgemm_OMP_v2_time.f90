...
!$OMP Parallel Do Schedule(dynamic)  Private(j,k,i,pdum,zdum,c_tag, d_tag, X_thom, d_RHS, P_b)
!&OMP& FirstPrivate(beta, alphaY,Lamby,alphaZ,Lambz,P_a, P_bb,P_c) Collapse(2)
	 Do j=1,Nysol
	  Do k=1,Nzsol
	            pdum =( -(Ckor/Htime)*Dtm +  Lamby(j) + Lambz(k) )
