 ...
 *
 * @warning Some Tensor operations are declared before their implementations are complete.
 *
...
public:
     ...
     *
     * This low-level view constructor exposes the tensor storage layout directly.
     * Prefer the named layer accessors when possible.
     *
     * @param startRow First row in the view.
     * @param startCol First column in the view.
     * @param startLayer First layer in the view.
     * @param height Number of rows in the view.
     * @param width Number of columns in the view.
     * @param ld Leading dimension of the returned matrix view.
     * @return Matrix view sharing memory with this tensor.
     */
