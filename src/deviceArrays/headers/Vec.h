...
public:
     ...
     *
     * @param length Number of elements.
     * @param stride Stride, in elements, between consecutive logical entries.
     ...
     * @param result Device scalar receiving the norm.
     * @param hand CUDA/cuBLAS handle used for the operation.
     */
