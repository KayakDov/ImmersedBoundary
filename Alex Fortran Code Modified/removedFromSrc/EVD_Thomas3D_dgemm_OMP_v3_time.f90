Subroutine  EVD_Thomas1 (f_New, f_rhs, Ey, Ey_inv, Ez, Ez_inv, &
...
!$OMP Parallel Do Schedule(dynamic)  Private(j,k,i,pdum,zdum,c_tag, d_tag, X_thom, d_RHS, P_b, Bmat1, Bmat2), &
!$OMP&    FirstPrivate(NxSol, NySol, Ey, Ey_inv, Lamby,Lambz, P_a, P_bb, P_c)
       Do k=1,Nzsol
