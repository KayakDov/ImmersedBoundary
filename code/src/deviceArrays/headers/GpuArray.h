/**
 * @file GpuArray.h
 * @brief Defines the common base interface for GPU-resident array views and containers.
...
public:
    /**
     * @brief Destructor for the GpuArray class.
     *
     * Device memory is released when the final shared owner of the allocation is destroyed.
     *
     ...
     *
     * The source and destination logical sizes must match.
     *
