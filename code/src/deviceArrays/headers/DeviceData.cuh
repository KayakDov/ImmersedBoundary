/**
 * @file DeviceData.cuh
 * @brief Defines lightweight kernel-side views over one-, two-, and three-dimensional device data.
...
#include "deviceArrays/headers/Support/AdjacencyIndex.cuh"
...
public:
    ...
    __device__ const T& operator()(const GridInd3d& ind0, int32_t dRow, int32_t dCol, int32_t dLayer) const {
